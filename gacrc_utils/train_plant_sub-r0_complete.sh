...
# make
./darknet detector train cfg/plant-weed-obj.data cfg/plant-weed-yolov3-tiny-r0.cfg yolov3-tiny.conv.15 -dont_show -map > ./train_complete/output_${PBS_JOBID}.log
#./darknet detector train cfg/coco.data cfg/yolov3-tiny.cfg yolov3-tiny.conv.15 -dont_show -map
