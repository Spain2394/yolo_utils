...
for filename in ./data/label_predict; do
    ...
    time ./darknet detector test ./cfg/plant-weed-obj.data ./cfg/plant-weed-yolov3-tiny-r0.cfg ./train_382_r0/plant-weed-yolov3-tiny-r0_final.weights $line -dont_show -ext_output >> $(dirname "$filename")"/"$(basename "$filename" .jpg).txt
done
