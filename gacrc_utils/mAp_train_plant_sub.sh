...
# make
./darknet detector map ./cfg/plant-weed-obj.data ./cfg/plant-weed-yolov3-tiny-r0.cfg ./train_complete/plant-weed-yolov3-tiny-r0_best.weights > ./train_complete/output_${PBS_JOBID}
